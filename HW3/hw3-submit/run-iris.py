...
def plot_sse(data):
    ...
    plt.xticks(np.arange(2,41,step=1))
    plt.title("SSE vs K Values")
    plt.xlabel("K Values")
    plt.ylabel("SSE")
    plt.savefig('SSE-plot-iris.png')
    plt.show()
...
def plot_silhouette(data):
    ...
    plt.savefig('Silhouette-plot-iris.png')
    plt.show()
...
def main():
    ...
    if no_plot:
        ...
        # visualize clusters 
        # km.visualize_iris(xTest,y_hat_test,centroids_test)
        km.visualize_iris(xTrain,y_hat_train,centroids_train)
